            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        ...
                        <h4 class="m-0" style="float: right; color: #0F394C;">Permohonan Verifikasi Jurnal
                        </h4>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                            ...
                            <div class="col-lg-12">
                                <div class="card shadow">
                                    <div class="card-header d-flex justify-content-between align-items-center justify-content-md-end"
                                        ...
                                        <a class="btn btn-light" href="{{ route('admin.create.jurnal') }}"><i

...
<head>
    ...
    <!-- Favicons -->
    <link href="{{ asset('/img/logo_unpad1.png') }}" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a href="" class="logo"><img src="img/logo_unpad1.png" alt="" class="img-fluid"></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 pt-4 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1>Aplikasi Portofolio Mahasiswa UNPAD</h1>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div
                        ...
                        <a href="https://youtu.be/MRwZ6TgBNZ0?si=fdQNoEiZgmrJrRPg" class="glightbox play-btn mb-4"></a>
                    </div>

                    <div
                        class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
                        <h3>Aplikasi Portofolio Mahasiswa</h3>
                        <p style="text-align: justify;">Merupakan aplikasi bagi mahasiswa Universitas Padjadjaran
                            membuat
                            portofolio.

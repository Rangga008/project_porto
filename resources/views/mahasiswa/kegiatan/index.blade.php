            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        ...
                        <h4 class="mt-1" style="float: right; color: #0F394C;">Kelola Kegiatan
                        </h4>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                            ...
                            <div class="col-lg-12">
                                <div class="card shadow">
                                    <div class="card-header d-flex justify-content-between align-items-center justify-content-md-end"
                                        ...
                                        <a class="btn btn-light" href="{{ route('kegiatan.create') }}"><i
                                                class="bi-plus-circle me-2"></i>Tambah
                                            Kegiatan</a>
                                    </div>
                                    <div class="card-body" id="show_all_kegiatan">
                                        <table id="tabel_kegiatan"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="vertical-align: middle">
                                                            <a style="background:transparent; text-decoration: none; vertical-align: middle"
                                                                href="{{ route('kegiatan.edit', $kgt->id) }}">
